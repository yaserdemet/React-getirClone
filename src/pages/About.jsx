...
const About = () => {
 ...
 <div className='outer-card'>
  ...
  <ul className="list-group list-group-flush">
    <li className="list-group-item"> <TbUserCircle 
    /> ddemety@gmail.com</li>
...
<div className='img-card'>
  ...
  <ul className="list-group list-group-flush">
    <li className="list-group-item"> <TbUserCircle /> mozz@gmail.com</li>
    <li className="list-group-item">
      <span> <FiHeart 
      id="3"
       onClick={handleClick}
...
<div className='img-card'>
  ...
  <ul className="list-group list-group-flush">
    <li className="list-group-item"> <TbUserCircle /> heil-isildur@hotmail.com</li>
    <li className="list-group-item">
      <span> <FiHeart 
       onClick={handleClick}
       /> </span>
